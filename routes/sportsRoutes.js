...
router.get('/', function (req, res) {
    sportsModel.find(function (err, sportss) {
        ...
        return res.render('sports',{ posts: sportss,trendings:sportss,category:"sports" , randomImage:"black,sports"});
    });
});
...
router.get('/:id', function (req, res) {
    ...
    sports_detailModel.findOne({id: req.params.id}, function (err, sports_detail) {
        ...
        return res.render('post',{ message: sports_detail,category:"Sports",randomImage:"Sports"});
    });
});
