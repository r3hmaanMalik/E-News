 ...
 */
 router.get('/', function (req, res) {
     entertainmentModel.find(function (err, entertainments) {
         ...
         return res.render('sports',{ posts: entertainments,trendings:entertainments,category:"entertainment",randomImage:"lahore"});
     });
 });
 ...
 */
 router.get('/:id', function (req, res) {
     ...
     ent_detailModel.findOne({id: req.params.id}, function (err, entdetail) {
         if (err) {
             return res.status(500).json({
         ...
         return res.render('post',{ message: entdetail,randomImage:"films",category:"entertainment"});
     });
 });
